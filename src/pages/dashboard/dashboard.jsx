...
const Dashboard = () => {
  ...
  // console.log(...routes);
  const iconArray = [['dashboard', <BiHomeAlt />], ['institution', <FiBarChart2 />], ['products', <ImStack />], ['users', <BsCheck2Square />], ['accounts', <FiFlag />], ['reports', <BiFile />], ['CE-ID', <AiOutlineIdcard />], ['profile', <FiUser />], ['log out', <MdLogout />], ['caret', <CgChevronDown />]];
  return (
